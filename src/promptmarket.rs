...
pub struct Prompt<M: ManagedTypeApi> {
    ...
    pub offer:BigUint<M>,               //Montant proposé
    ...
    pub limit:u8                        //Limit max de proposition
}
...
pub struct Render<M: ManagedTypeApi> {
    ...
    pub creator:usize,
    pub price:BigUint<M>                   //Prix du rendering
}
...
pub trait PromptMarket {
    ...
    #[endpoint]
    #[payable("*")]
    fn add_prompt(&self, text: ManagedBuffer,model:u8,inference:u16,scale:u16,limit:u8) -> usize {
        ...
        let prompt = Prompt {
            text: text,
            offer:token_payment.amount.clone(),
    ...
    #[endpoint]
    fn add_render(&self, prompt_id:usize,url:ManagedBuffer,price:BigUint) -> usize {
        /*
        ...
        */
        ...
        require!(!self.closed_prompt().contains(&prompt_id),"Ce prompt est clôt");
